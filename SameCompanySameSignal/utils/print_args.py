def print_args(args):
    ...
    print(f'  {"Task Name:":<10}{args.task_name:<20}{"Is Training:":<10}{args.is_training:<20}{"Model:":<10}{args.model:<20}')
    print(f'  {"Model ID:":<20}{args.model_id:<40}')
    print()

    print("\033[1m" + "Data Loader" + "\033[0m")
    print(f'  {"Data:":<20}{args.data:<40}{"Root Path:":<20}{args.root_path:<40}')
    print(f'  {"Data Path:":<20}{args.data_path:<40}{"Features:":<20}{args.features:<40}')
    # print(f'  {"Target:":<20}{args.target:<20}{"Freq:":<20}{args.freq:<20}')
    # print(f'  {"Checkpoints:":<20}{args.checkpoints:<20}')
    print()

    print("\033[1m" + "Misc" + "\033[0m")
    print(f'  {"Rolling Test Quarter:":<20}{args.rolling_test:<40}')
    # print(f'  {"Target:":<20}{args.target:<20}{"Freq:":<20}{args.freq:<20}')
    # print(f'  {"Checkpoints:":<20}{args.checkpoints:<20}')
    print()

    if args.task_name in ['short_term_forecast_earnings', 'mm_short_term_forecast_earnings']:
        print("\033[1m" + "Forecasting Task" + "\033[0m")
        print(f'  {"Seq Len:":<20}{args.seq_len:<20}{"Label Len:":<20}{args.label_len:<20}')
        print(f'  {"Pred Len:":<20}{args.pred_len:<20}{"Encoding Dim:":<20}{args.enc_in:<20}')
        print()
